            ...
            <div class=" flex flex-wrap">
                ...
                <div class="w-full px-4 lg:w-1/2">
                    ...
                    <div class="flex items-center">
                        <!-- LinkedIN -->
                        <a target="_blank" href="https://wa.me/628989011101" class="w-9 h-9 mr-3 rounded-2xl flex justify-center items-center border border-secondary hover:border-primary hover:bg-primary hover:text-white dark:text-third dark:hover:text-dark"> 
                        ...
                        <a target="_blank" href="https://instagram.com/rhnrafif"
                            class="w-9 h-9 mr-3 rounded-2xl flex justify-center items-center border border-secondary hover:border-primary hover:bg-primary hover:text-white dark:text-third dark:hover:text-dark">
                            <svg role="img" viewBox="0 0 24 24" width="20" class="fill-current" xmlns="http://www.w3.org/2000/svg">
